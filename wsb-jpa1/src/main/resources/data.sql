...
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (1, 'Ania', 'Blabla', '555666777', 'whoknows@gmail.com', 'PAT001', '1985-10-10', 1);
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (2, 'Justyna', 'Yapyap', '444555666', 'whoknowsher@gmail.com', 'PAT002', '1990-05-15', 2);
...
INSERT INTO medical_treatment (id, description, type, visit_id) VALUES (1, 'Blood test', 'LAB', 1);
INSERT INTO medical_treatment (id, description, type, visit_id) VALUES (2, 'CT scan', 'IMAGING', 2);
INSERT INTO medical_treatment (id, description, type, visit_id) VALUES (3, 'Cardiology consultation', 'CONSULTATION', 1);
